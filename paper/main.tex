...
\end{tabular}}
\vspace{2pt}
\begin{minipage}{\linewidth}\footnotesize \emph{Electricity (321 clients), same protocol:} frozen MASE 1.376, CRPS 0.237, coverage 0.79; SFT 1.389 / 0.240 / 0.80; GRPO $-$MSE 1.374 / 0.237 / 0.78; GRPO composite 1.371 / 0.237 / 0.77; all intervals include zero.\end{minipage}
\end{table}
