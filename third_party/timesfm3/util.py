...
def update_running_stats(
  ...
  inc_sigma = torch.sqrt(inc_var.clamp_min(1e-12))   # [tsfm-research] clamp: sqrt'(0) = inf gives NaN gradients when training through the CPM refinement
